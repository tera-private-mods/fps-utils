	...
	if (from_ver === undefined) {
		...
		switch (to_ver) {
			...
			case 10:
				...
				break;
			default:
				console.log(`\x1b[94mINFO\x1b[34m [FPS-UTILS]\x1b[39m - Your \x1b[31m'config.json'(caali's proxy)/'settings/fps-utils.json'(pinkie's proxy)\x1b[39m seems to be mega outdated.\x1b[32m Re-created new one.\x1b[39m\x1b[0m`);
