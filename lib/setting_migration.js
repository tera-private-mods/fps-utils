	...
	if (from_ver === undefined) {
		...
		switch (to_ver) {
			...
			case 12:
				...
				settings.AbnormalitiesBlacklist = DefaultSettings.AbnormalitiesBlacklist;
				break;
			case 13: //Someday I'll move this key to the core script instead of keep doing this bs.
				settings._version = 13;
				settings.AbnormalitiesBlacklist = DefaultSettings.AbnormalitiesBlacklist;
				break;
			default:
				console.log(`\x1b[94mINFO\x1b[34m [FPS-UTILS]\x1b[39m - Your \x1b[31 ["config.json" (caali's proxy) OR "settings/fps-utils.json" (pinkie's proxy)]\x1b[39m seems to be mega outdated.\x1b[32m Re-created new one.\x1b[39m\x1b[0m`);
