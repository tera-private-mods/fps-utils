...
module.exports = function FpsUtils(mod) {
	...
	const InvisibleNpcs = { 8: [6011], 12: [1], 23: [201, 202], 34: [8000], 61: [9901], 62: [1039, 1040, 1041, 1042, 1900, 1901, 1902, 1903, 9001, 9002, 9003, 9004, 9901], 83: [9901], 207: [9901], 212: [1034], 223: [9901], 230: [9901] };
				...
				switch (whose) {
					case 'own':
						for (let p in HPets) {
							...
							mod.toClient('S_REQUEST_SPAWN_SERVANT', 1, HPets[p])
							delete HPets[p]
						}
						break;
					case 'others':
	...
	mod.hook('S_REQUEST_SPAWN_SERVANT', 1, sRequestSpawnServant)
	...
	mod.hook('S_SPAWN_DROPITEM', 7, sSpawnDropItem)
