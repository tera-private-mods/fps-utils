	...
	function GuiHandler(page, arg) {
		switch (page) {
			...
			case "proj":
				...
				TmpData = []
				break;
			case "help":				//TO DO - Better formating, it looks messy.
				gui.parse([
					{ text: `<font color="${PurpleClr}" size="+24"><p align="right">MAIN MENU</p></font><br>`, command: `fps gui` },
					...
					{ text: `<font color="${HBlueClr}" size="15" style="font-family:Consolas,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New, monospace;">` },
					...
					{ text: `|    'dropitem'    |    N/A \| 'hide' \<num\>   |'!fps dropitem'       |Hides/shows blacklisted drops.    |<br>` },
					{ text: `| 'monsterdeathani'|             N/A            |'!fps monsterdeathani'|Hides/shows death animations.     |<br>` },
					{ text: `</font>` }
			...
			default:
				gui.parse([
					...
					{ text: `&#09;&#09;&#09;` },
					{ text: `<font color="${mod.settings.HideMonsterDeathAnimation ? GreenClr : RedClr}" size="+17">[Monsters Death Animation]</font><br><br>`, command: `fps monsterdeathani;fps gui` },
