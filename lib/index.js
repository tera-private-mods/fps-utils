...
module.exports = function FpsUtils(mod) {
	...
	const NotCP = typeof mod.compileProto !== 'undefined',
		sUserLocationVer = mod.majorPatchVersion < 105 ? 5 : 6
	...
	function UpdateUserLoc(event) {
		mod.toClient('S_USER_LOCATION', sUserLocationVer, { gameId: event.gameId, loc: event.loc, w: event.w, speed: 300, dest: event.loc, type: 7 });
	}
	...
	mod.hook('S_USER_LOCATION', sUserLocationVer, Last_Hook, sUserLocation)
