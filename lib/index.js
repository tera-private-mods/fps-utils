...
module.exports = function FpsUtils(mod) {
	...
	const ImportantAbns = [
		90440009, 90442106, 90442110, 90442111, 90442112, 90442113, 90442114, 90442400, 90442401, 90442402, 90442403, 90442404, 90442405, 90442406, 90442407, 90442408, 90442502,

		78200123, // - Stunned; Cannot move.
		78200126, // - Eye debuff.

		78200130, // - pink circle?
		78200131, // - violet circle?

		// 78200142 - blue circle?
		// 78200143 - purple effect with gathering?

		// 78200148 - Delicate Green Aroma
		// 78200149 - Sweet Violet Aroma

		// 78200157 - rose flower above head
		// 78200158 - yellow=>white flower with shaking
		// 78200157 - yellow explosion

		78200161, // - BIG dount (green effect)
		78200162, // - BIG dount (blue effect)

		//78200165 - Heavy blue-white debuff?

		78200203, // - Bloody Statue's Gaze
		78200204, // - Radiant Statue's Gaze
		78200205, // - Cursed Statue's Gaze

		78200209, // - Restraint; The three statues bind Ptakum.
		78200234, // - Restraint; A statue binds you.
		78200235, // - Restraint; Two statues bind you.
		78200236, // - Restraint; Three statues bind you.
	];
		...
		switch (page) {
			...
			default:
				gui.parse([
					...
					{ text: `<font color="${YlwC}" size="+21">Party:</font>` }, { text: "&#09;" },
					...
					{ text: `<font color="${YlwC}" size="+21">System:</font>` }, { text: "&#09;" },
	...
	function sSpawnNpc(event) {
		...
		//if (mod.settings.ShowStyle) { event.repairable = false; return true; } // {p}artially... This option is used not only for the icons above npcs heads, but it's used also for showing the whole shape of some npcs, e.g. bahaar & glsh. :\
	}
	...
	function sActionStage(event) {
		if (EqGid(event.gameId) || !SUsers[event.gameId] || event.skill.npc) return;
	...
	mod.hook('S_PARTY_MEMBER_LIST', 7, Last_Hook, sPartyMemberList)
	...
	mod.hook('S_EACH_SKILL_RESULT', 12, Last_Hook, sEachSkillResult)
