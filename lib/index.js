...
const NotCP = typeof global.TeraProxy === 'undefined'; //For niceName forced thing and broken settings auto-save For Caalis Proxy users.
...
module.exports = function FpsUtils(mod) {
	...
	if (NotCP) mod.settings = require('./setting_migration')(mod.settings._version, require('../module').options.settingsVersion, mod.settings) // Believe or not, this still needed for some cases. ._.
		...
		switch (page) {
			...
			case "help":
				gui.parse([
					...
					{ text: `<font color='${HBlueClr}'>fish ^ fishing</font>            <font color='${DBlueClr}'>N/A</font>                    <font color='${HPinkClr}'>!fps fishing</font><br>` },
					{ text: `</font>` }
	...
	//mod.hook('S_QUEST_VILLAGER_INFO', 'raw', sQuestVillagerInfo) opcode not public.
	...
	//mod.hook('S_USER_APPEARANCE_CHANGE', 1, { order: 9999 }, sUserAppearanceChange) missing opcode for pinkie proxy ._.
