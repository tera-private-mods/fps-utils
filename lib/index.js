	...
	function GuiHandler(page, arg) {
		switch (page) {
			...
			case "proj":
				...
				TmpData = []
				break;
			case "help":				//TO DO - Better formating, it looks messy. ##Attempt 2
				gui.parse([
					{ text: `<font color="${PurpleClr}" size="+24"><p align="right">MAIN MENU</p></font><br>`, command: `fps gui` },
					{ text: `<font color="${PinkClr}" size="+17"><p align="right">Note: This page not completely developed yet, if you can't understand anything, just go check the README, Thank you.</p></font><br>` },
					{ text: `<font color="${HBlueClr}" size="15">` }, //style="font-family:Consolas,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New, monospace;" doesn't work ._.
					{ text: "  Command(s)  &#09;&#09;&#09;&#09;Argument(s)&#09; &#09; Example<br>" },
					{ text: "  gui  ~  g&ensp;&#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps gui<br>" },
					{ text: "&#09; N/A&#09;  &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps-util<br>" },
					{ text: "0 ~ 1 ~ 2 ~ 3 &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!0 ~ !1 ~ !2 ~ !3<br>" },
					{ text: "mode  ~  state&#09;&#09;&ensp;0  ~  1  ~  2  ~  3  &#09;!fps mode 2<br>" },
					{ text: "hide  ~  show &#09;&#09;  Player ~ Class ~ Role &#09;!fps hide mie<br>" },
					{ text: "&#09;party&#09; &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps party<br>" },
					{ text: "&#09; raid&#09; &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps raid<br>" },
					{ text: "&#09; list&#09; &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps list<br>" },
					{ text: "summons ~ sums&#09;&#09;&#09;  other ~  me&#09;&ensp;&#09;!fps sums me<br>" },
					{ text: "skill ~ skills&#09;&#09;  blacklist ~ Class arg &#09;!fps skill blacklist<br>" },
					{ text: "  npc  ~ npcs &#09;&#09;&#09; N/A ~  hide arg&#09;&#09;!fps npc<br>" },
					{ text: "&#09;  hit&#09; &#09;&#09;&ensp;me ~ other ~ damage  &#09;!fps hit me<br>" },
					{ text: "&#09;firework  &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps firework<br>" },
					{ text: "abn ~ abnormal&#09;&#09; all~blacklist arg arg2 &#09;!fps abn blacklist<br>" },
					{ text: "&#09;  proj&#09;&#09;&#09; all~blacklist arg arg2 &#09;!fps proj all<br>" },
					{ text: "&ensp;guildlogo  &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps guildlogo<br>" },
					{ text: "style~costume &#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps style<br>" },
					{ text: "gui npcsearch &#09;&#09;&#09;  &#09;  arg&#09;&#09; &#09;!fps gui npcsearch E<br>" },
					{ text: "&#09;npczoom&ensp;&#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps npczoom<br>" },
					{ text: "&#09;dropitem  &#09;&#09;&#09;  N/A ~  hide arg&ensp;&#09;!fps dropitem<br>" },
					{ text: "monsterdeathani&#09;&#09;&#09;&#09;&#09;N/A&#09;&#09;&#09;&#09;!fps monsterdeathani<br>" },
					{ text: "  screenabns  &#09;&#09;&#09;  N/A ~  hide arg&ensp;&#09;!fps screenabns<br>" },
					{ text: "</font>" }
