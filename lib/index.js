...
const ImportantAbns = [31040001, // Immortal Blood (Red Aura for Hug mechanic. - CA instance)
	90440009, 90442106, 90442110, 90442111, 90442112, 90442113, 90442114, 90442400, 90442401, 90442402, 90442403, 90442404, 90442405, 90442406, 90442407, 90442408, 90442502, 78200123, 78200126, 78200130, 78200131, 78200161, 78200162, 78200203, 78200204, 78200205, 78200209, 78200234, 78200235, 78200236];
...
module.exports = function FpsUtils(mod) {
	...
	function ProjectileBCheck(event) {
		...
		if (event.skill.id === 90120 /*Ninja smoke btw - Should be always shown, no matter options were set, now enabled */ || (mod.settings.PvpTraps && TrapsIds.includes(event.skill.id))) return undefined;
	...
	mod.hook('S_SPAWN_NPC', 12, Last_Hook, sSpawnNpc)
