...
module.exports = function FpsUtils(mod) {
	...
	if (!Xmap.has(mod.dispatch || mod)) { //TODO; sth for this.
		...
		switch (page) {
			...
			default:
				gui.parse([
					...
					{ text: `<font color="${mod.settings.Hit_Me ? GrnC : RedC}" size="+18">[Own(self)]</font>`, command: "fps hit me;fps gui" }, { text: "&nbsp;&nbsp;" },
					{ text: `<font color="${mod.settings.Hit_Damage ? GrnC : RedC}" size="+18">[Damage numbers]</font>`, command: "fps hit damage;fps gui" }, { text: "&nbsp;&nbsp;" },
	...
	//mod.hook('S_QUEST_VILLAGER_INFO', 'raw', sQuestVillagerInfo) opcode currently not public, but soon it will be. **someday** qq
