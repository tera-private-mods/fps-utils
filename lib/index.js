...
module.exports = function FpsUtils(mod) {
	...
	const NpcData = require("./data/npc.json"), SkillData = require("./data/skill.json");
	...
	//mod.hook('S_QUEST_VILLAGER_INFO', 'raw', sQuestVillagerInfo) Currently the opcode for this ain't public, but it will be soon™.
