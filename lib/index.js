...
module.exports = function FpsUtils(mod) {
	...
	mod.hook('S_LOGIN', mod.majorPatchVersion < 86 ? 13 : 14, sLogin)
	...
	if (mod.majorPatchVersion < 86) mod.hook('S_UPDATE_ACHIEVEMENT_PROGRESS', 1, Last_Hookfn, sUpdateAchievementProgress)
	...
	mod.hook('S_ABNORMALITY_BEGIN', 3, Last_Hook, sAbnormalityBegin)		//ToDo v4
	mod.hook('S_ABNORMALITY_REFRESH', 1, Last_Hook, sAbnormalityRefresh)	//ToDo v2
	...
	mod.hook('S_EACH_SKILL_RESULT', mod.majorPatchVersion < 86 ? 13 : 14, Last_Hook, sEachSkillResult)
