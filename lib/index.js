...
module.exports = function FpsUtils(mod) {
	...
	const FishingNpcs = {
		8: [6011],		//frog
		12: [1, 2],		//crab, bay kamara
		23: [201, 202],	//frog, bee
		34: [8000],		//goat
		61: [9901],		//Ostgarath - Vexatus Swamp
		62: [1017, 1035, 1039, 1040, 1041, 1042, 1900, 1901, 1902, 1903, 9001, 9002, 9003, 9004, 9901], //Ostgarath - Cutthroat Harbor
		83: [9901],									//Westonia - Celsian Lake
		99: [1180, 1181, 1182, 1183, 1184, 1185],	//All invisible ?_? - unknown area.
		207: [9901],								//Arcadia - Muricai
		212: [1034],								//Cutthroat followup
		223: [9901, 9906, 9907, 9915, 9925],		//Poporia - Lake of Tears
		230: [9901],								//Veritas District - Seren's Lake
